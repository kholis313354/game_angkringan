...
function GameScreen({ playerName, onGameOver }) {
  ...
  useEffect(() => {
    ...
    backsoundRef.current = new Audio(`${baseUrl}sound/backsound.mp3`)
    eatSoundRef.current = new Audio(`${baseUrl}sound/memakan.mp3`)
    gameOverSoundRef.current = new Audio(`${baseUrl}sound/gameover.mp3`)
  ...
  return (
    <div className="game-screen" style={{ backgroundImage: `url(${baseUrl}img/background.png)` }}>
      <div className="game-container" style={{ width: dimensions.width, height: dimensions.height }}>
        ...
        <div className="game-area">
          ...
          {items.map(item => (
            ...
            >
              <img
                src={`${import.meta.env.BASE_URL}img/${item.type}`}
          ...
          >
            <img
              src={`${import.meta.env.BASE_URL}img/${characterImage}`}
              alt="character"
              style={{
                width: '100%',
                height: '100%'
